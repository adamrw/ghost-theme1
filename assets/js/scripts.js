/*! ghostTheme1- v1.0.0 - 2014-11-04
* https://github.com/adamrw/ghost-theme1
* Copyright (c) 2014 Adam Weiner - MIT License
*/
...
;(function ($) {
    "use strict";
		...
		function AppViewModel() {
			...
			$.extend(this, window.ghostTheme1);
			
			//this.config = window.ghostTheme1.config;
		}
